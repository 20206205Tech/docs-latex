...
\subsubsection{Quy ước đặt tên ảnh}
...
\subsubsection{1. Người dùng khách và xác thực}

\paragraph{Trang chủ khách}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-GuestHome.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-GuestRegister.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-GuestSignupConfirmEmail.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-GuestRegistrationEmail.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-GuestLogin.png}
\caption{Đăng nhập}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-MfaQrSetup.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-MfaCodeVerify.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-UserProfile.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-ChangePasswordAndMfa.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-UserSettings.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-ResetPassword.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-PasswordResetEmail.png}
...
\subsubsection{2. Trò chuyện, ghi chú và chia sẻ}

\paragraph{Chat văn bản}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-ChatText.png}
...
\paragraph{Chat bằng micro}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-ChatMicrophone.png}
...
\paragraph{Tạo ghi chú bookmark}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-BookmarkNoteCreate.png}
...
\paragraph{Quản lý ghi chú bookmark}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-BookmarkNoteManage.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-ShareCreate.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-ShareManage.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-ShareLinkUnavailable.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-ShareLinkDone.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-ShareRevoke.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-ChatDelete.png}
...
\subsubsection{3. Quản trị hệ thống}

\paragraph{Quản lý gói VIP}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-AdminPlans.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-AdminPersonas.png}
...
\paragraph{Quản lý engine}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-AdminEngines.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-AdminVoices.png}
...
\paragraph{Pipeline dữ liệu VBPL}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-AdminDataPipelineVbpl.png}
...
\paragraph{Pipeline dữ liệu Pháp Điển}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-AdminDataPipelinePhapDien.png}
...
\subsubsection{4. Thanh toán và gói VIP}

\paragraph{Danh sách gói thanh toán}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-PaymentPlanList.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-PaymentHistory.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-PaymentSuccess.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-PaymentSuccessEmail.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-PaymentPlanActive.png}
...
\subsubsection{5. Voice chat}

\paragraph{Chọn giọng nói}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-VoiceSelect.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-VoiceChat.png}
...
\subsubsection{6. Tài liệu cá nhân}

\paragraph{Tải lên tài liệu}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-DocumentUpload.png}
...
\paragraph{Chat với tài liệu}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{contents/WebUI-DocumentChat.png}
