...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.3]{pictures/docker-hub-web-ui2.png}
\caption{Kết quả các Docker Image được push lên Docker Hub}
\end{figure}

Lưu ý:
Image vuvannghiawork/code-chatbot-service được đặt là private
vì là Image quan trọng nhất của toàn bộ dự án.
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.3]{pictures/argocd-web-ui.png}
