...
\item \textbf{\texttt{[prefix]\_share\_generated}}: Yêu cầu tạo trang chia sẻ trò chuyện công khai (đóng gói dạng JSONL và tải lên Cloudflare R2) (Durable: \texttt{true}, DLQ Routing: \texttt{[prefix]\_share\_generated\_dlq}).
...
\item \textbf{\texttt{[prefix]\_share\_upload\_completed}}: Báo cáo kết quả đóng gói và upload file chia sẻ từ Python về lại NestJS (Durable: \texttt{true}, DLQ Routing: \texttt{[prefix]\_share\_upload\_completed\_dlq}).
