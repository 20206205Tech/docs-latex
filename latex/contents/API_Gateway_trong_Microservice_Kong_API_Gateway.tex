...
\label{fig:kong-gateway-overview}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.2]{pictures/kong-api-gateway-project-v2.png}
\caption{Cấu trúc dự án Kong API Gateway trên công cụ quản trị}
\label{fig:kong-api-gateway-project}
\end{figure}
...
\caption{request Kong API Gateway bị hacker}
% \caption{Cấu hình biến môi trường và bí mật (Secrets) cho Kong API Gateway}
\label{fig:kong-api-gateway-env-secret}
\end{figure}
...
\label{fig:request-response-result-kong-api-gateway}
\end{figure}
...
\label{fig:kong-api-gateway-router}
\end{figure}
...
\label{fig:kong-api-gateway-plugin}
\end{figure}
\begin{figure}[H]
\centering
\includegraphics[scale = 0.2]{pictures/kong-api-gateway-github-action-v2.png}
\caption{Luồng CI/CD triển khai cấu hình Kong API Gateway qua GitHub Actions}
\label{fig:kong-api-gateway-github-action}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{pictures/kong-api-gateway-request-id-not.png}
\caption{Phản hồi lỗi từ hệ thống khi yêu cầu (Request) thiếu mã định danh Request ID}
\label{fig:kong-api-gateway-request-id-not}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{pictures/kong-api-gateway-request-kong-secret-not.png}
\caption{Phản hồi chặn truy cập từ Kong API Gateway khi yêu cầu thiếu mã bảo mật Kong Secret}
\label{fig:kong-api-gateway-request-kong-secret-not}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{pictures/kong-api-gateway-request-kong-secret-invalid.png}
\caption{Phản hồi lỗi xác thực từ Kong API Gateway khi mã bảo mật Kong Secret không hợp lệ}
\label{fig:kong-api-gateway-request-kong-secret-invalid}
\end{figure}
