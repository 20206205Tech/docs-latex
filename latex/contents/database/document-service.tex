...
% \end{tabular}
% \caption{Bảng \texttt{request\_logs} (Dịch vụ văn bản)}
% \end{table}
...
\end{tabular}
\caption{Bảng \texttt{user\_subscriptions} lưu thông tin đồng bộ gói thuê bao của người dùng từ dịch vụ thanh toán để xác thực quyền tải lên tài liệu}
\end{table}
...
\end{tabular}
\caption{Bảng \texttt{documents} quản lý thông tin tài liệu tải lên, trạng thái bóc tách nội dung, tóm tắt và mã băm để tối ưu hóa tài nguyên}
\end{table}
