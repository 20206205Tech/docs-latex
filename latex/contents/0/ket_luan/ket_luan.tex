...
% NestJS, Python (LangGraph, FastAPI), gRPC, RabbitMQ, Apache Kafka, Qdrant Vector Database, cùng hạ tầng tự động hóa CI/CD, Docker và Kubernetes được quản lý qua GitOps (ArgoCD).
