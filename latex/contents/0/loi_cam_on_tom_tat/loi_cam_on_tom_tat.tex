...
Qua thời gian học tập và rèn luyện tại \textit{Đại học Bách khoa Hà Nội},
...
với
đề tài: \textit{Xây dựng ứng dụng hỗ trợ tư vấn pháp luật sử dụng công nghệ trí tuệ nhân tạo}.
...
Đồ án
được thực hiện nhằm giải quyết nhu cầu tra cứu và giải đáp thông tin pháp luật Việt Nam (bao gồm Văn bản pháp luật và Pháp điển) một cách chính xác, nhanh chóng và tự động hóa.
...
và được điều phối qua Kong API Gateway.
Nhằm đảm bảo tính ổn định và khả năng mở rộng,
giao tiếp bất đồng bộ giữa các dịch vụ (NestJS và Python)
được xử lý thông qua Message Broker RabbitMQ.
Luồng nghiệp vụ
quy trình thanh toán thuê bao VIP
qua các cổng nội địa (VNPay, MoMo, ZaloPay, SePay),
được đồng bộ
bằng nền tảng streaming sự kiện Kafka.
...
cùng các mô hình xử lý giọng nói tiên tiến như Whisper (Speech-to-Text), Piper và ElevenLabs (Text-to-Speech).
...
% \item Dự án bài đánh giá kỹ năng Backend ban đầu
