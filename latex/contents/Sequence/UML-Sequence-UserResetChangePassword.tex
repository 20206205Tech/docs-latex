...
\item Auth Service xác minh token, tự thực hiện mã hóa và lưu mật khẩu mới, sau đó trả về thông tin cập nhật để Frontend chuyển hướng người dùng vào \texttt{/chat}.
\end{itemize}
