...
Người dùng điền địa chỉ thư điện tử và nhấn nút yêu cầu khôi phục mật khẩu. Giao diện gửi yêu cầu khôi phục qua cổng API đến auth service.

\item \textbf{Gửi email liên kết:}
auth service tự tạo mã khôi phục mật khẩu, ghi nhận thời hạn sử dụng của mã này và trực tiếp gửi một thư điện tử chứa đường dẫn liên kết đặt lại mật khẩu đến thư điện tử của người dùng.
\end{itemize}
