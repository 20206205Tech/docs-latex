...
Web Frontend & Component & Gọi \texttt{conversationService.streamChat}, xử lý SSE và hiển thị status, nội dung, reasoning steps, sources. \\ \hline
API Gateway (Kong) & Component & Định tuyến request stream có Bearer Token tới Conversation Service. \\ \hline
