...
\begin{itemize}
\item \textbf{Nhấp liên kết xác nhận:} Người dùng nhấn vào liên kết xác thực trong thư điện tử. Yêu cầu được gửi qua cổng kết nối tới dịch vụ chứng thực để kiểm tra tính hợp lệ của mã xác nhận.
\item \textbf{Chuyển hướng trình duyệt:} Nếu mã hợp lệ, dịch vụ chứng thực trả về yêu cầu chuyển hướng trình duyệt của người dùng đến trang tiếp nhận của giao diện kèm theo mã xác thực tạm thời trong địa chỉ trang web.
\item \textbf{Xác thực hai lớp:} Giao diện nhận phản hồi, lưu trữ mã xác thực tạm thời và chuyển hướng người dùng sang trang đổi mật khẩu. Sau khi vượt qua bước xác thực hai lớp, hệ thống mới cho phép người dùng đặt lại mật khẩu mới.
\end{itemize}
