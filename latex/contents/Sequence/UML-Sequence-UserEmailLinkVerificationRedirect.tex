...
\begin{itemize}
\item \textbf{Nhấp liên kết xác nhận:} Người dùng nhấn vào liên kết xác thực trong thư điện tử. Yêu cầu được gửi qua cổng API tới dịch vụ chứng thực để kiểm tra tính hợp lệ của mã xác nhận.
