...
Người dùng nhấn vào liên kết xác thực trong thư điện tử. Yêu cầu được gửi qua cổng API tới auth service để kiểm tra tính hợp lệ của mã xác nhận.

\item \textbf{Chuyển hướng trình duyệt:}
Nếu mã hợp lệ, auth service trả về yêu cầu chuyển hướng trình duyệt của người dùng đến trang tiếp nhận của giao diện kèm theo mã xác thực tạm thời trong địa chỉ trang web.
