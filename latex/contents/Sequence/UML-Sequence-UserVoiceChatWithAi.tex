...
Luồng nghiệp vụ này mô tả phiên voice chat sau khi client đã join LiveKit room. Voice Agent trong Chatbot Service nhận audio, đọc metadata từ participant, resolve persona để cập nhật DynamicTTS, gọi công cụ RAG khi câu hỏi liên quan pháp luật hoặc tài liệu cá nhân, sau đó phát audio phản hồi qua LiveKit.
