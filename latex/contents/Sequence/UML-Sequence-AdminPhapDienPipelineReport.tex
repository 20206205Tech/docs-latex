...
\begin{itemize}
\item \textbf{Yêu cầu xem báo cáo:} Admin truy cập vào Dashboard quản trị. Web Frontend gửi yêu cầu lấy số liệu thống kê Pháp Điển bằng phương thức \texttt{GET /phapdien/summary} qua Kong API Gateway.
...
\item \textbf{Lấy danh mục bổ sung:} Web Frontend gọi thêm API để hiển thị dữ liệu chủ đề, đề mục trên Dashboard.
