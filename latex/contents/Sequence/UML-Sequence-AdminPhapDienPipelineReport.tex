...
của luồng xử lý dữ liệu Pháp Điển Việt Nam tự động (Pháp Điển Pipeline) thông qua giao diện Bảng điều khiển (Admin Dashboard).
...
Quản trị viên
truy cập màn hình báo cáo. Giao diện gửi yêu cầu lấy số liệu thống kê về tiến trình xử lý dữ liệu pháp điển qua cổng API.
...
Giao diện nhận dữ liệu, tính toán tiến độ hoàn thành và vẽ biểu đồ trực quan giúp Quản trị viên
