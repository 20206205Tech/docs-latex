...
\begin{itemize}
\item \textbf{Yêu cầu xem báo cáo:} Quản trị viên truy cập màn hình báo cáo. Giao diện gửi yêu cầu lấy số liệu thống kê về tiến trình xử lý dữ liệu pháp điển qua cổng API.
\item \textbf{Kiểm tra và định tuyến:} Cổng API xác thực thông tin đăng nhập của quản trị viên và chuyển tiếp yêu cầu đến dịch vụ xử lý dữ liệu pháp điển.
