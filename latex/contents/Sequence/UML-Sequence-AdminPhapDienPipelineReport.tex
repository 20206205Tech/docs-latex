...
\item \textbf{Kiểm tra và định tuyến:} Cổng API chuyển tiếp yêu cầu đến dịch vụ xử lý dữ liệu pháp điển. % Cổng API xác thực thông tin đăng nhập của quản trị viên và chuyển tiếp yêu cầu đến dịch vụ xử lý dữ liệu pháp điển.
\item \textbf{Thống kê dữ liệu:} Dịch vụ xử lý dữ liệu pháp điển truy vấn CSDL thống kê để lấy tổng số chủ đề, tổng số đề mục và tổng số nút thư mục trong hệ thống pháp điển, sau đó phản hồi số liệu tổng hợp về giao diện.
