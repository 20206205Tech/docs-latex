...
Dịch vụ nhân vật lọc theo mã nhà cung cấp, kiểm tra sự tồn tại của từng giọng nói
trong CSDL dựa trên mã định danh: nếu chưa có thì thêm mới giọng nói vào CSDL,
nếu đã có thì bỏ qua không cập nhật.

\item \textbf{Hoàn tất:}
Dịch vụ nhân vật phản hồi kết quả gồm số lượng giọng nói đã đồng bộ
và danh sách mã giọng nói về giao diện để thông báo cho quản trị viên.
