...
\begin{itemize}
\item \textbf{Yêu cầu xem lịch sử:} Người dùng mở trang lịch sử giao dịch. Giao diện gửi yêu cầu lấy danh sách lịch sử qua cổng API kèm theo các tham số phân trang và mã đăng nhập.
