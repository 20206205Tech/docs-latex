...
\begin{itemize}
\item \textbf{Yêu cầu tra cứu:} User mở trang Lịch sử giao dịch. Web Frontend gọi API với tham số \texttt{skip}, \texttt{limit} và Bearer Token.
\item \textbf{Xử lý truy vấn:} Payment Service tạo lấy danh sách transaction và lấy total.
\item \textbf{Ánh xạ DTO:} Backend ánh xạ mỗi transaction thành item.
