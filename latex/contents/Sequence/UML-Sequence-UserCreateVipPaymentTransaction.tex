...
\item \textbf{Tạo transaction và timeout job:} Service lấy \texttt{PAYMENT\_DEFAULT\_PROVIDER} với mặc định \texttt{vnpay}, tạo transaction mới, rồi đăng ký job timeout trên BullMQ với delay 10 phút.
\item \textbf{Tạo link thanh toán:} Service gọi Payment Gateway Selector để chọn provider tương ứng và tạo \texttt{payment\_url}. Frontend dùng \texttt{apiHelper} bóc \texttt{data} để nhận trực tiếp \texttt{\{ payment\_url \}}.
