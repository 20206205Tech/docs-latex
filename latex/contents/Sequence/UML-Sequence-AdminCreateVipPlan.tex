...
\item \textbf{Gửi yêu cầu:} Giao diện gửi yêu cầu tạo gói thuê bao VIP mới kèm mã xác thực qua cổng API. Cổng API xác thực tài khoản và phân quyền của quản trị viên trước khi chuyển tiếp yêu cầu.
