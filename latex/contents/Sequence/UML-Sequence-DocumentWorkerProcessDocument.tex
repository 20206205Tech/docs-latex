...
\item \textbf{Tạo mã nhúng tìm kiếm:} Các đoạn nhỏ của tài liệu được chuyển đổi sang dạng vector nhúng và lưu vào CSDL vector cùng thông tin người sở hữu, mã tài liệu và tên tệp tin để phục vụ tìm kiếm.
