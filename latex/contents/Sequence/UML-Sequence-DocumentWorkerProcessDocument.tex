...
Document Service đã gửi Celery task \texttt{process\_document\_task(doc\_id)} vào RabbitMQ.
...
và lưu vào CSDL vector cùng thông tin người sở hữu, mã tài liệu và tên tệp tin để phục vụ tìm kiếm.

\item \textbf{Hoàn tất xử lý:}
Khi hoàn tất, trạng thái tài liệu được cập nhật thành đã hoàn thành kèm thông tin xác nhận đã trích xuất nội dung và tóm tắt.
