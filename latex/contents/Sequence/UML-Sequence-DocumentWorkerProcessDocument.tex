...
\begin{itemize}
\item \textbf{Nhận nhiệm vụ:} Tiến trình xử lý tài liệu nhận nhiệm vụ xử lý một tài liệu cụ thể từ hàng đợi tin nhắn.
\item \textbf{Tải tài liệu:} Tiến trình cập nhật trạng thái tài liệu sang đang xử lý và tải tệp tài liệu gốc từ kho lưu trữ trực tuyến.
\item \textbf{Phân tích và tóm tắt:} Tiến trình phân tích nội dung tài liệu và tạo phần tóm tắt, sau đó tải các nội dung này lên kho lưu trữ trực tuyến dưới dạng các thư mục nội dung và tóm tắt riêng biệt.
\item \textbf{Tạo mã nhúng tìm kiếm:} Các đoạn nhỏ của tài liệu được chuyển đổi sang dạng vector nhúng và lưu vào cơ sở dữ liệu vector cùng thông tin người sở hữu, mã tài liệu và tên tệp tin để phục vụ tìm kiếm.
\item \textbf{Hoàn tất xử lý:} Khi hoàn tất, trạng thái tài liệu được cập nhật thành đã hoàn thành kèm thông tin xác nhận đã trích xuất nội dung và tóm tắt. Nếu xảy ra lỗi trong quá trình xử lý, trạng thái tài liệu sẽ chuyển sang thất bại.
\end{itemize}
