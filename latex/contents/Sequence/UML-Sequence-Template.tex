\paragraph{Sơ đồ tuần tự luồng xxxxxxxxxxxx}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{contents/Sequence/UML-Sequence-01.png}
\caption{Sơ đồ tuần tự luồng xxxxxxxxxxxx}
\end{figure}
...
\end{tabular}
\caption{Các thành phần tham gia luồng xxxxxxxxxxxx}
\end{table}
