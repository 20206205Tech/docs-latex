...
\item \textbf{Lấy transaction metadata:} Handler tìm transaction để lấy thông tin khách hàng thah toán và \texttt{transactionRef}. Nếu không có \texttt{customer\_email}, handler ghi log cảnh báo và bỏ qua gửi email.
...
\item \textbf{Gửi email:} Handler gọi Brevo Email Adapter.
\end{itemize}
