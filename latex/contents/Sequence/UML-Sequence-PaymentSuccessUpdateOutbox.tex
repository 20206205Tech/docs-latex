\paragraph{Sơ đồ tuần tự luồng cập nhật giao dịch thành công và ghi Outbox}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{contents/Sequence/UML-Sequence-PaymentSuccessUpdateOutbox.png}
\caption{Sơ đồ tuần tự luồng cập nhật giao dịch thành công và ghi Outbox}
\end{figure}
...
\end{tabular}
\caption{Các thành phần tham gia luồng cập nhật giao dịch thành công và ghi Outbox}
\end{table}
