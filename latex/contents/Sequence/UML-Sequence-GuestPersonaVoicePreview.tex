...
Khách vãng lai chọn chức năng nghe thử giọng nói của một nhân vật trên trang chủ.

\item \textbf{Tải luồng âm thanh:}
Giao diện gửi yêu cầu tải luồng âm thanh trực tiếp đến địa chỉ kho chứa tệp công khai của nhân vật mà không cần qua cổng API hay dịch vụ máy chủ.

\item \textbf{Nhận âm thanh:}
Kho chứa trả về dữ liệu luồng âm thanh của nhân vật dưới dạng tệp âm thanh thông dụng.

\item \textbf{Phát âm thanh:}
Giao diện tiếp nhận luồng dữ liệu và phát âm thanh trực tiếp cho người dùng nghe.
\end{itemize}
