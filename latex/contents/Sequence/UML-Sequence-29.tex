...
Pha này mô tả bước User chọn gói thuê bao VIP trên Web Frontend, hệ thống kiểm tra gói dịch vụ, chuẩn bị Subscription, tạo Transaction ở trạng thái \texttt{pending}, đăng ký job timeout trên Redis BullMQ, sau đó gọi Payment Gateway để sinh đường link thanh toán.

\begin{figure}[H]
\centering
\includegraphics[scale = 0.18]{contents/Sequence/UML-Sequence-29.png}
...
Web Frontend & Component & Gửi yêu cầu mua gói thuê bao VIP, nhận \texttt{payment\_url} sau khi \texttt{apiHelper} bóc \texttt{data}, rồi chuyển hướng người dùng đến link thanh toán. \\ \hline
