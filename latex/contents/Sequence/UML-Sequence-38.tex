...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.18]{contents/Sequence/UML-Sequence-38.png}
...
Web Frontend & Component & Gọi \texttt{documentService.uploadDocument} bằng multipart form data. \\ \hline
API Gateway (Kong) & Component & Định tuyến request tới Document Service. \\ \hline
