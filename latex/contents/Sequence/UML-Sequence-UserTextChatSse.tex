...
Khi hoàn thành câu trả lời cuối cùng, dịch vụ chatbot lưu câu trả lời của hệ thống cùng các bước lập luận, nguồn tài liệu tham khảo và trạng thái chờ xác nhận vào CSDL chatbot, đồng thời cập nhật chủ đề cuộc trò chuyện hoặc chạy tác vụ tóm tắt nội dung cuộc trò chuyện trong nền nếu cần.
\end{itemize}
