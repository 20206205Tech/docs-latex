...
Giao diện gửi yêu cầu trò chuyện truyền dữ liệu liên tục kèm mã cuộc trò chuyện, nội dung câu hỏi, danh sách tài liệu chọn phân tích, tùy chọn sử dụng lập luận nâng cao và mã đăng nhập qua cổng API.
...
Dịch vụ trò chuyện kiểm tra mã cuộc trò chuyện để đảm bảo cuộc trò chuyện còn tồn tại và đang hoạt động; nếu không tìm thấy sẽ trả về thông báo lỗi.
