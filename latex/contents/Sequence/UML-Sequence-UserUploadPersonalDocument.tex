...
% \item Document Service kiểm tra \texttt{UserSubscription.is\_active=true} và \texttt{period\_end >= now}.
% \item File được validate, tính hash/size và tạo bản ghi Document.
