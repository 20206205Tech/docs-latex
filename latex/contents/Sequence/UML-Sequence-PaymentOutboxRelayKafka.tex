...
\begin{itemize}
\item \textbf{Quét danh sách sự kiện:} Tiến trình định kỳ quét bảng sự kiện chờ gửi trong CSDL để lấy danh sách các sự kiện giao dịch đang chờ xử lý hoặc đã thất bại nhưng chưa vượt quá số lần thử lại tối đa.
