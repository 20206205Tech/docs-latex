\paragraph{Sơ đồ tuần tự luồng Pha Outbox Relay xuất bản sự kiện mua VIP lên Kafka}
...
\caption{Sơ đồ tuần tự luồng Pha Outbox Relay xuất bản sự kiện mua VIP lên Kafka}
\end{figure}
...
\end{tabular}
\caption{Các thành phần tham gia luồng pha Outbox Relay xuất bản sự kiện mua VIP lên Kafka}
\end{table}
