...
Luồng nghiệp vụ này mô tả \texttt{OutboxRelayCron} của Payment Service đọc các bản ghi Outbox chưa xử lý, kiểm tra payload của \texttt{SubscriptionPurchasedEvent}, publish sự kiện mua gói VIP lên Kafka thông qua \texttt{MessageBrokerPort}, rồi cập nhật trạng thái Outbox.
