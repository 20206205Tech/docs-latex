...
auth service gửi yêu cầu chuyển hướng trình duyệt của người dùng về trang xử lý của giao diện kèm theo mã phiên đăng nhập và mã làm mới phiên trong địa chỉ trang web.
