...
\begin{itemize}
\item \textbf{Gửi callback/IPN:} Payment Gateway gửi thông tin thông báo thanh toán.
\item \textbf{Xác minh IPN:} Payment Service gọi Payment Gateway Selector để thực hiện nhận kết.
