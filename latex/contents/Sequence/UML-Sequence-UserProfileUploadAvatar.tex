\paragraph{Sơ đồ tuần tự luồng Tải lên và Cập nhật Ảnh đại diện (Upload Avatar)}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.18]{contents/Sequence/UML-Sequence-UserProfileUploadAvatar.png}
...
Supabase Backend (Storage, DB, Auth) & Component & Dịch vụ backend tích hợp của Supabase quản lý lưu trữ tệp tin (Storage), cơ sở dữ liệu (Database) và xác thực/truy vấn (Auth). \\ \hline
\end{tabular}
