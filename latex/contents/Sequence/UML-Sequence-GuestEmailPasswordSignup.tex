...
auth service tạo tài khoản mới trong CSDL với trạng thái chưa xác thực thư điện tử.

\item \textbf{Gửi thư xác thực:}
auth service gửi thư điện tử xác nhận chứa mã xác thực và đường dẫn liên kết kích hoạt đến thư điện tử của người dùng.

\item \textbf{Phản hồi kết quả:}
auth service gửi phản hồi đăng ký thành công và đang chờ xác thực về giao diện.
