...
Giao diện gửi yêu cầu đăng nhập trực tiếp qua cổng API đến auth service.

\item \textbf{Kiểm tra tài khoản:}
auth service kiểm tra thông tin đăng nhập và đảm bảo tài khoản đã hoàn tất xác thực thư điện tử trước đó.

\item \textbf{Cấp mã phiên:}
Nếu thông tin chính xác, auth service tạo cặp mã đăng nhập và mã làm mới phiên đăng nhập gửi về qua cổng API.
