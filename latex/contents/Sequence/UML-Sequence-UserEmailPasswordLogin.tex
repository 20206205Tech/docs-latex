...
Người dùng điền địa chỉ thư điện tử và mật khẩu, sau đó chọn đăng nhập trên giao diện.
\item \textbf{Yêu cầu đăng nhập:}
Giao diện gửi yêu cầu đăng nhập trực tiếp qua cổng API đến dịch vụ chứng thực.
\item \textbf{Kiểm tra tài khoản:}
Dịch vụ chứng thực kiểm tra thông tin đăng nhập và đảm bảo tài khoản đã hoàn tất xác thực thư điện tử trước đó.
\item \textbf{Cấp mã phiên:}
Nếu thông tin chính xác, dịch vụ chứng thực tạo cặp mã đăng nhập và mã làm mới phiên đăng nhập gửi về qua cổng API.
\item \textbf{Xác thực bổ sung:}
Cổng API chuyển tiếp thông tin đăng nhập về giao diện. Giao diện thực hiện lưu trữ các mã đăng nhập cục bộ và chuyển hướng người dùng sang trang xác thực hai lớp. Sau khi hoàn thành xác thực hai lớp đạt mức bảo mật yêu cầu, người dùng được chuyển hướng vào màn hình trò chuyện chính.
\end{itemize}
