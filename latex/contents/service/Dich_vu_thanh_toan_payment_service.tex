...
payment\_method & varchar & Phương thức thanh toán được chọn (Stripe, Paypal,...). \\ \hline
transaction\_ref & varchar & Mã tham chiếu giao dịch đối tác cổng thanh toán. \\ \hline
payment\_status & transaction\_payment\_status\_enum & Trạng thái thanh toán của giao dịch (pending, completed, failed,...). \\ \hline
...
version & int4 & Phiên bản của bản ghi phục vụ optimistic locking. \\ \hline
\end{tabular}
