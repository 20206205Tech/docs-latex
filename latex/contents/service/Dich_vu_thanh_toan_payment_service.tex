...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pictures/payment-swagger.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{pictures/payment-heroku.png}
\caption{Kết quả triển khai dịch vụ thanh toán trên Heroku}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{pictures/payment-redis-v2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pictures/payment-PR.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{pictures/payment-database-migration.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{pictures/payment-database.png}
...
timestamp & int8 & Thời gian khi di chuyển được thực thi. \\ \hline
name & varchar & Tên file migration đã thực thi. \\ \hline
\end{tabular}
\caption{Cấu trúc bảng \texttt{migrations} (Dịch vụ thanh toán)}
\end{table}
...
\end{tabular}
\caption{Cấu trúc bảng \texttt{request\_logs} (Dịch vụ thanh toán)}
\end{table}
...
\end{tabular}
\caption{Cấu trúc bảng \texttt{plan} (Dịch vụ thanh toán)}
\end{table}
...
version & int4 & Số phiên bản của bản ghi. \\ \hline
\end{tabular}
\caption{Cấu trúc bảng \texttt{subscription} (Dịch vụ thanh toán)}
\end{table}
...
\end{tabular}
\caption{Cấu trúc bảng \texttt{transaction} (Dịch vụ thanh toán)}
\end{table}
...
\end{tabular}
\caption{Cấu trúc bảng \texttt{outbox\_messages} (Dịch vụ thanh toán)}
\end{table}
...
\end{tabular}
\caption{Cấu trúc bảng \texttt{outbox\_messages\_archive} (Dịch vụ thanh toán)}
\end{table}
...
\texttt{subscriptionId} & UUID & Mã định danh duy nhất của thuê bao \\ \hline
\texttt{userId} & UUID & Mã định danh người dùng mua gói \\ \hline
\texttt{planId} & UUID & Mã định danh gói dịch vụ đã mua \\ \hline
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{pictures/event-outbox.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{pictures/payment-ipn-i1.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.99\textwidth]{pictures/payment-ipn-i2.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.62\textwidth]{pictures/payment-vnpay.png}
