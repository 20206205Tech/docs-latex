...
email & text & Địa chỉ email của quản trị viên được phép truy cập hệ thống. \\ \hline
\end{tabular}
...
full\_name & text & Họ và tên đầy đủ của người dùng. \\ \hline
avatar\_url & text & Đường dẫn URL dẫn tới ảnh đại diện của người dùng lưu trên Storage. \\ \hline
\end{tabular}
