...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pictures/auth-jwt-supabase.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pictures/why-totp.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pictures/auth-mail.png}
\caption{Mẫu email HTML được cấu hình}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pictures/auth-terraform-supabase-diagram.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pictures/nest-auth.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pictures/20206205tech-nestjs-auth-file-architecture.png}
\caption{Sơ đồ tệp và thư mục trong gói chung NestJS Auth}
\end{figure}
