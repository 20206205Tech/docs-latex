...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pictures/r2per.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pictures/persona-database-migration.png}
\caption{Quản lý migration CSDL của dịch vụ nhân vật}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pictures/persona-database.png}
