...
\subparagraph{Danh sách các Hàng đợi (Queues) trong hệ thống}
...
\subparagraph{Cấu trúc dữ liệu và Luồng xử lý sự kiện (Event Payloads \& Flow)}

\textbf{Sự kiện Xóa trò chuyện (Chat Deletion Event)}
\begin{itemize}
...
\textbf{Xử lý lệch thứ tự sự kiện Tạo Share và Thu hồi/Xóa Share (Out-of-Order Handling)}
\begin{itemize}
