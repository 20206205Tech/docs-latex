...
\item Sử dụng cron-job.org sẽ gửi một request đến GitHub API đúng theo khung giờ cấu hình. Cách này giúp bypass cơ chế schedule mặc định của GitHub Actions thường xuyên bị trễ từ 15 đến 30 phút.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{pictures/dlt-auto.png}
