...
\item $T_X$ là thời gian của OTP (mặc định là 30 giây)
\end{itemize}
...
Tóm lại, TOTP sử dụng khóa bí mật có thể hiển thị dưới dạng mã QR cho người dùng. Từ đó, máy chủ và phần mềm Authenticator đều có thể tính được giá trị của OTP theo thuật toán. Cuối cùng, khi cần xác thực OTP thì người dùng nhập giá trị OTP của phần mềm Authenticator để máy chủ tiến hành so sánh.
