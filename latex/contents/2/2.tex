...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.4]{pictures/doppler-telegram.png}
\caption{Cấu hình chia nhỏ bí mật theo từng nhu cầu sử dụng trong doppler}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.2]{pictures/docker-hub-web-ui2.png}
\caption{Cấu hình chia nhỏ bí mật theo từng nhu cầu sử dụng trong doppler}
\end{figure}

% TODO: chatbot được private do quan trọng nhất
