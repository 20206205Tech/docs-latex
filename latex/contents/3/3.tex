...
![alt text](images/zxcvb/kong-gateway-overview-light.svg)
...
![alt text](images/zxcvb/kong-api-gateway-project.png)
...
![alt text](images/zxcvb/request-response-result-Kong-API-Gateway.excalidraw.png)
...
![alt text](images/zxcvb/kong-api-gateway-router.png)
