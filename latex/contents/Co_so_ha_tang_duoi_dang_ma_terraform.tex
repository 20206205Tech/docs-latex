...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.07]{pictures/infrastructure-as-code-IaC-terraform.excalidraw.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.3]{pictures/infrastructure-project-v2.png}
