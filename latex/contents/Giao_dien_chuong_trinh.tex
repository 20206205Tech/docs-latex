...
\caption{Quản lý ghi chú đánh dấu}
\end{figure}
...
\caption{Quản lý công cụ dịch vụ giọng nói}
\end{figure}
...
\caption{Đường ống dữ liệu VBPL}
\end{figure}
...
\caption{Đường ống dữ liệu Pháp Điển}
\end{figure}
...
\begin{enumerate}
\item Bắt đầu phiên trò chuyện bằng giọng nói.
...
\caption{Trò chuyện với tài liệu}
\end{figure}
