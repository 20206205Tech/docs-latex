\subsubsection{Giao diện chương trình}

\paragraph{1. Người dùng khách và xác thực}

\subparagraph{Trang chủ khách}
...
\subparagraph{Đăng ký tài khoản}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-GuestRegister.png}
...
\subparagraph{Thông báo xác thực email}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-GuestSignupConfirmEmail.png}
...
\subparagraph{Email xác thực đăng ký}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-GuestRegistrationEmail.png}
...
\subparagraph{Đăng nhập}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-GuestLogin.png}
\caption{Đăng nhập}
\end{figure}
...
\subparagraph{Thiết lập MFA bằng mã QR}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-MfaQrSetup.png}
...
\subparagraph{Xác minh mã MFA}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-MfaCodeVerify.png}
...
\subparagraph{Hồ sơ người dùng}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-UserProfile.png}
...
\subparagraph{Đổi mật khẩu và MFA}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-ChangePasswordAndMfa.png}
...
\subparagraph{Cài đặt người dùng}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-UserSettings.png}
...
\subparagraph{Khôi phục mật khẩu}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-ResetPassword.png}
...
\subparagraph{Email khôi phục mật khẩu}
...
\paragraph{2. Trò chuyện, ghi chú và chia sẻ}

\subparagraph{Chat văn bản}
...
\subparagraph{Chat bằng micro}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-ChatMicrophone.png}
...
\subparagraph{Tạo ghi chú bookmark}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-BookmarkNoteCreate.png}
...
\subparagraph{Quản lý ghi chú bookmark}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-BookmarkNoteManage.png}
...
\item Chỉnh sửa ghi chú, đổi thư mục hoặc mở lại cuộc trò chuyện.
\end{enumerate}

\subparagraph{Tạo liên kết chia sẻ}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-ShareCreate.png}
...
\subparagraph{Liên kết chia sẻ không khả dụng}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-ShareLinkUnavailable.png}
...
\subparagraph{Liên kết chia sẻ khả dụng}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-ShareLinkDone.png}
...
\item Dùng nội dung này để tham khảo mà không cần quyền chỉnh sửa cuộc trò chuyện gốc.
\end{enumerate}

\subparagraph{Thu hồi chia sẻ}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-ShareRevoke.png}
...
\subparagraph{Xóa cuộc trò chuyện}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-ChatDelete.png}
...
\paragraph{3. Quản trị hệ thống}

\subparagraph{Quản lý gói VIP}
...
\subparagraph{Quản lý engine}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-AdminEngines.png}
...
\subparagraph{Quản lý giọng nói}
...
\subparagraph{Pipeline dữ liệu VBPL}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-AdminDataPipelineVbpl.png}
...
\subparagraph{Pipeline dữ liệu Pháp Điển}
...
\paragraph{4. Thanh toán và gói VIP}

\subparagraph{Danh sách gói thanh toán}
...
\subparagraph{Lịch sử thanh toán}
...
\subparagraph{Thanh toán thành công}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-PaymentSuccess.png}
...
\subparagraph{Email thanh toán thành công}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{pictures/WebUI/WebUI-PaymentSuccessEmail.png}
...
\subparagraph{Gói VIP đang hoạt động}
...
\paragraph{5. Voice chat}

\subparagraph{Chọn giọng nói}
...
\subparagraph{Trò chuyện bằng giọng nói}
...
\paragraph{6. Tài liệu cá nhân}

\subparagraph{Tải lên tài liệu}
...
\subparagraph{Chat với tài liệu}
