...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{pictures/auth-terraform-supabase-diagram.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{pictures/20206205tech-nestjs-auth-file-architecture.png}
