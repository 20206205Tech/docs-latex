...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{pictures/zip_file_PhapDien-v2.png}
\caption{Sơ đồ thu thập dữ liệu chung}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{pictures/data-pipeline-phapdien-step-download-zip-new.png}
