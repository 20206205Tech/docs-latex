...
% \textbf{Nhánh Fast vs. Agentic sau khi truy xuất:}
% Fast mode lấy top-5 tài liệu qua \texttt{Fast RAG}
% và đi thẳng vào \texttt{Advisor},
% kết thúc ngay sau khi có câu trả lời.
\item
