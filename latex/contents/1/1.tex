...
% Sử dụng LangSmith trong dự án
% Sử dụng Langfuse trong dự án
...
\subsubsection{Kiến trúc vi dịch vụ MSA (Microservice Architecture)}
...
Kiến trúc tổng quan các dịch vụ của dự án:


\begin{figure}[H]
\centering
\includegraphics[scale = 0.2]{pictures/MSA.png}
\caption{Kiến trúc tổng quan các dịch vụ của dự án}
\end{figure}


\subsubsection{Thiết kế hướng miền DDD (Domain Driven Design)}
...
% Trong service `Payment`, có `PaymentDomainService` để điều phối giữa 3 Aggregate khác nhau: `Transaction`,`Subscription`, và `Plan`.
