...
\caption{Kích hoạt Data API trên Neon}
...
\caption{Bật RLS cho bảng settings trên Neon}
...
Thay vì tạo một Route chung cho tất cả các request,
hệ thống được cấu hình để phân loại riêng biệt luồng đọc (\texttt{GET}) và luồng ghi (\texttt{POST}).
Tham số \texttt{strip\_path=true} giúp Kong loại bỏ tiền tố URI trước khi chuyển tiếp request đến Neon.
